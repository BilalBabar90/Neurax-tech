            ...
            <Card key={index} className="service-card group p-6 h-full">
              ...
              <CardContent className="space-y-6">
                ...
                <div className={`p-4 rounded-lg ${
                  study.color === 'primary' ? 'bg-primary/5' : 'bg-accent/5'
                } border-l-4 ${
                  study.color === 'primary' ? 'border-primary' : 'border-accent'
                }`}>
                ...
                <div className="flex gap-3 pt-2">
                  <button 
                    ...
                    className={`flex-1 px-4 py-2 rounded-full font-semibold text-white transition-all duration-200 hover:opacity-90 ${
                      study.color === 'primary' 
                  ...
                  <button 
                    ...
                    className={`px-4 py-2 rounded-full font-semibold border transition-all duration-200 hover:opacity-90 ${
                      study.color === 'primary' 
