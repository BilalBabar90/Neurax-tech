  ...
  >
    ...
    Preview
      ...
      <div className="text-center max-w-3xl mx-auto my-12">
        <h2 className="text-4xl md:text-3xl font-bold mb-6 text-orange-600">
        ...
        <a
          href="#contact"
          className="inline-block px-6 py-3 rounded-full bg-orange-600 text-white font-semibold shadow-md hover:bg-orange-400 transition"
        >
          Let’s Talk
